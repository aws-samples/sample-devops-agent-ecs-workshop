...
echo ""
echo "Issue injected: Task execution role can no longer access Secrets Manager"
echo ""
echo "Expected symptoms:"
echo "  - Orders service tasks fail to start"
echo "  - Error: 'unable to pull secrets or registry auth'"
echo "  - Customers cannot place orders"
echo ""
echo "Investigation prompts for DevOps Agent:"
echo "  'Why is the orders service failing to start?'"
echo "  'Check the stopped tasks for the orders service and show me the error details'"
echo "  'What IAM permissions does the orders service task execution role have?'"
echo ""
echo "To fix: ./labs/lab2-secrets-access-denied/fix.sh"
